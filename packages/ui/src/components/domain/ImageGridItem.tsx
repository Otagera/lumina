import { ImageIcon, MoreHorizontal, Trash2, Heart, Download } from "lucide-react";
  ...
  return (
    <div
      className={cn(
        ...
        containerClassName,
        isSelected && "ring-4 ring-sage ring-offset-4 dark:ring-offset-zinc-950 scale-[0.98]"
      )}
    ...
    >
      ...
      <div className="absolute inset-0 bg-black/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-20" />
      ...
      <div className="absolute bottom-3 left-3 right-3 flex justify-between items-end z-30 pointer-events-none">
        {onReaction && !selectionMode && (
          <button
            ...
            className={cn(
              "pointer-events-auto flex items-center gap-2 px-3 py-1.5 bg-white/90 dark:bg-zinc-900/90 text-zinc-900 dark:text-white rounded-full transition-all duration-300 shadow-xl border border-white/20 active:scale-95 group/heart",
