...
export const AlbumPermissionsModal = ({
	...
	return (
		<Modal
			...
			description="Manage who has access to this album and their roles."
		>
			<div className="space-y-6 mt-4">
				{/* Generate Invite Section */}
				<div className="p-4 bg-zinc-50 dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-800 rounded-card">
							...
							<div className="flex gap-2">
								{["VIEWER", "CONTRIBUTOR", "ADMIN"].map((role) => (
									<button
										...
										className={`flex-1 py-2 rounded-xl text-xs font-bold transition-all border ${selectedRole === role
				...
				<div className="space-y-3">
					...
					<div className="space-y-2">
						{joinedMembers.map((member: any) => (
							<div
								key={member.id}
								className="relative flex items-center justify-between p-3 bg-zinc-50 dark:bg-zinc-950 border border-zinc-100 dark:border-zinc-800 rounded-card"
							>
								...
								<div className="flex items-center gap-2">
									<div className="relative">
										<button
											...
											aria-label={`Change role for ${member.user?.email || "member"} (current: ${member.role})`}
							...
							{pendingInvites.map((member: any) => {
								...
								return (
									...
									>
										<div className="flex items-center gap-3">
											<div
												className={`w-8 h-8 rounded-full flex items-center justify-center ${expired
											...
											<div>
												...
												<p
													className={`text-[10px] font-medium ${expired ? "text-red-500" : "text-zinc-500"
														}`}
												>
