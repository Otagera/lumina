...
export function AlbumHeader({
	...
	return (
		<div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
			<div className="flex flex-col lg:flex-row items-start lg:items-center gap-4 lg:gap-6 min-w-0 flex-1 w-full">
				<Card className="group relative w-28 md:w-32 aspect-[3/4] p-0 border-none overflow-hidden bg-zinc-100 dark:bg-zinc-800 shrink-0 shadow-lg">
				...
				<div className="flex flex-col items-start gap-1 min-w-0 flex-1 w-full">
					<div className="flex items-center gap-2 group min-w-0 w-full">
						...
						>
							<input
								...
								className="flex-1 w-full text-2xl md:text-5xl lg:text-6xl font-black text-zinc-900 dark:text-white bg-transparent border-b-2 border-sage focus:outline-none px-1 min-w-0"
								autoFocus
							/>
							<Button
								size="sm"
						...
						>
							<Heading
								level={1}
								className="text-2xl md:text-5xl lg:text-6xl truncate"
							>
								{album?.albumName}
							</Heading>
							<button
			...
			<div className="flex flex-wrap items-center gap-2 lg:pb-1 shrink-0">
				<Button
					variant="outline"
					size="sm"
					onClick={onTriggerClustering}
					className="text-[10px] sm:text-xs flex-1 lg:flex-none h-9 px-3"
				>
					<svg
